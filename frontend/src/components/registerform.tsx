...
export default function Register() {
  ...
  return (
    <div className="w-[1920px] h-[1080px] relative bg-white outline outline-1 outline-offset-[-1px] outline-zinc-300 overflow-hidden">
      ...
      <div className="left-[1198px] top-[884px] absolute justify-start">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="button">
          <button
            type="submit"
            className="w-[575px] h-14 left-[1042px] top-[805px] absolute justify-start text-white text-base font-extrabold font-['Telegraf'] leading-10 tracking-wider"
          >
            Create Account
          </button>
        </div>
        {message && (
          <div className="left-[1042px] top-[860px] absolute text-red-600 font-bold">
            {message}
          </div>
        )}
      </form>
      ...
      <div className="w-[473px] h-60 left-[79px] top-[163px] absolute justify-start">
        <span className="text-white text-5xl font-normal font-['Telegraf'] leading-[60px] tracking-widest">Need webdesign <br />for your business? <br /></span>
        <span className="text-indigo-500 text-5xl font-extrabold font-['Telegraf'] leading-[60px] tracking-widest">Design Spacee</span>
        <span className="text-white text-5xl font-normal font-['Telegraf'] leading-[60px] tracking-widest"> will help you.  </span>
      </div>
